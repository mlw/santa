...
#ifndef SANTA__SANTAD__LOGS_ENDPOINTSECURITY_SERIALIZERS_PARQUET_H
#define SANTA__SANTAD__LOGS_ENDPOINTSECURITY_SERIALIZERS_PARQUET_H
...
#include "Source/santad/rust/parquet_bridge.rs.h"
// #include "Source/santad/rust/cxx.h"
#include "include/cxx.h"

namespace santa {

class Parquet : public Serializer {
 public:
  static std::shared_ptr<Parquet> Create(std::shared_ptr<santa::EndpointSecurityAPI> esapi,
                                         SNTDecisionCache *decision_cache,
                                         std::string spool_dir,
                                         bool prefix_time_name = true);

  Parquet(std::shared_ptr<santa::EndpointSecurityAPI> esapi, SNTDecisionCache *decision_cache,
          std::string spool_dir, bool prefix_time_name);
 ...
 private:
  ...
  rust::Box<santa::ExecEventBuilder> builder_;
};

}  // namespace santa

#endif  // SANTA__SANTAD__LOGS_ENDPOINTSECURITY_SERIALIZERS_PARQUET_H
